...
//	@Test
	...
	//@Test(dependsOnMethods ="invaliedCredentials")
	public void getFailedlogin_credential()
	{
		if(Status_errormsg ==true)
		{
		String username=driver.findElement(By.xpath("//input[@name='username' and @placeholder='Username']")).getAttribute("placeholder");
		System.out.println("Wrong credentials provided");	
		System.out.println("wrong username:"+username);
		String password=driver.findElement(By.xpath("//input[@name='password']")).getAttribute("placeholder");
...
//	@Test 
  ...
  //    @Test
    ...
    boolean passRec_msg=  driver.findElement(By.xpath("//div[@class='orangehrm-card-container']")).isDisplayed();
       s.assertTrue(passRec_msg);
